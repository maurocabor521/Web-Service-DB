...
//$consulta= "select idEjercicioG1 from `ejerciciog2`";
$consulta= "select idEjercicioG1 from `ejerciciog2 where docente_iddocente='{$iddocente}`";
//$sql = "SELECT idEjercicioG1,nameEjercicioG1 FROM `ejerciciog1`";
$sql = "SELECT * FROM `ejerciciog2`";
