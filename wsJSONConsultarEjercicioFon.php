...
$json=array();
	...
	$consulta="select idEjercicioG2,nameEjercicioG1,Tipo_idTipo,rutaImagen_EjercicioG1,cantidadValidaEjercicioG1,oracionEjercicioG2 from ejerciciog1 where idEjercicioG1='{$idEjercicioG1}' ";
