...
$json=array();
		...
		$consulta="select id_GE_H_D from grupo_estudiante_has_deber INNER JOIN grupo_estudiante 
		ON  grupo_estudiante.idgrupo_estudiante=grupo_estudiante_has_deber.grupo_estudiante_idgrupo_estudiante
		AND  grupo_estudiante.docente_iddocente='".$iddocente."'  ";
